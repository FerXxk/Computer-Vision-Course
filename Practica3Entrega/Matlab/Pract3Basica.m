...
switch imagen 
    case 1
        f = imread ("parche1_01.png");
    case 2
        f = imread ("parche1_02.png");
    case 3
        f = imread ("parche1_03.png");
    case 4
        f = imread ("parche2_01.png");
    case 5
        f = imread ("parche2_02.png");
    case 6
        f = imread ("parche2_03.png");
    case 7
        f = imread ("parche3_01.png");
    case 8
        f = imread ("parche3_02.png");
    case 9
        f = imread ("parche3_03.png");
    case 10
        f = imread ("parche4_01.png");
    case 11
        f = imread ("parche4_02.png");
end
...
%% Sacar líneas por hough

[M,N]=size(gEro); %% Tamaño de la imagen

figure(); imshow(f,[]); %% Dibujamos sobre la imagen original
...
for k = 1:size(intersecciones, 1) % Para cada intersección
    plot(intersecciones(k, 1), intersecciones(k, 2), 'b*', 'MarkerSize', 6, 'LineWidth', 2); % Dibujamos el punto
end
